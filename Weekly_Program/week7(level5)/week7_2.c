...
{   //XO game!!!
    ...
    {   m=0;
        ...
        while (k != -1)
        {
            ...
            {
                int j = 0;
                if (x[0][i]+x[1][i]+x[2][i] == 264 || x[0][i]+x[1][i]+x[2][i] == 237  || x[i][0]+x[i][1]+x[i][2]==237||x[i][0]+x[i][1]+x[i][2]==264 
                || x[0][0]+x[1][1]+x[2][2]==237||(x[0][0]+x[1][1]+x[2][2]==264) ||
                 x[0][2]+x[1][1]+x[2][0]==237||x[0][2]+x[1][1]+x[2][0]==264)
                {
